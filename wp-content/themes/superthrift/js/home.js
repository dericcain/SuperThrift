jQuery(document).ready(function () {
  ...
  function resizeMap() {
    ...
    var newHeight = (jQuery(window).height() - jQuery("#header").outerHeight());
    ...
    jQuery("#section-map").css("height", newHeight);
    jQuery("#map").css("height", newHeight);
    jQuery("#map-overlay").css("height", newHeight);
    
    var newHeight2 = (jQuery('#section-map').height() - jQuery("#map-search").outerHeight()) + "px";
    jQuery("#map-intro").css("height", newHeight2);
    jQuery("#map-intro-inner").css("height", newHeight2);
    jQuery("#map-intro-outer").css("height", newHeight2);
  ...
  function introFadeOut() {
    ...
    jQuery('#map-intro-background').fadeOut(500);
  }
  ...
  function getStoreContent(data)
  {
    ...
    html += '<div class="tabs-container">' +
        '<ul class="nav nav-tabs">' +
            '<li class="active"><a data-toggle="tab" href="#tab-1" aria-expanded="true"> Informations</a></li>' +
  ...
  function getDropboxContent(data)
  {
    ...
    html += '<h4 class="map-title-dropbox">' + data['name'] + '</h4>';
