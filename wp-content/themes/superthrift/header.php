    ...
    <nav id="header" class="navbar navbar-default navbar-static-top yamm sticky" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <h2><a class="navbar-brand" href="<?php echo esc_url(home_url('/')); ?>"><img
                            src="<?php echo get_template_directory_uri() . '/img/logo.png'; ?>"
                            alt="<?php echo get_bloginfo('name'); ?>"></a></h2>
            </div>
...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    <symbol viewBox="0 0 50 50" id="ios7-cancel">
        <path
            ...
            d="M 25 0 C 11.204726 0 0 11.204726 0 25 C 0 38.795274 11.204726 50 25 50 C 38.795274 50 50 38.795274 50 25 C 50 11.204726 38.795274 0 25 0 z M 25 2 C 37.714394 2 48 12.285606 48 25 C 48 37.714394 37.714394 48 25 48 C 12.285606 48 2 37.714394 2 25 C 2 12.285606 12.285606 2 25 2 z M 15.90625 14.96875 A 1.0001 1.0001 0 0 0 15.78125 15 A 1.0001 1.0001 0 0 0 15.28125 16.71875 L 23.5625 25 L 15.28125 33.28125 A 1.016466 1.016466 0 1 0 16.71875 34.71875 L 25 26.4375 L 33.28125 34.71875 A 1.016466 1.016466 0 1 0 34.71875 33.28125 L 26.4375 25 L 34.71875 16.71875 A 1.0001 1.0001 0 0 0 33.875 15 A 1.0001 1.0001 0 0 0 33.28125 15.28125 L 25 23.5625 L 16.71875 15.28125 A 1.0001 1.0001 0 0 0 15.90625 14.96875 z"
            color="#000" overflow="visible" enable-background="accumulate" font-family="Bitstream Vera Sans"></path>
    </symbol>
    <symbol viewBox="0 0 32 32" id="win10-long-arrow-down">
        <path
            style="text-indent:0;text-align:start;line-height:normal;text-transform:none;block-progression:tb;-inkscape-font-specification:Bitstream Vera Sans"
            d="M 15 4 L 15 24.0625 L 10.71875 19.78125 L 9.28125 21.1875 L 15.28125 27.1875 L 16 27.90625 L 16.71875 27.1875 L 22.71875 21.1875 L 21.28125 19.78125 L 17 24.0625 L 17 4 L 15 4 z"
            color="#000" overflow="visible" font-family="Bitstream Vera Sans"></path>
    </symbol>
    <symbol viewBox="0 0 24 24" id="android-shop">
        <path
            d="M 1 0 L 1 2 L 22 2 L 22 0 L 1 0 z M 1 3 C 1 3 0 9.326 0 9.5 C 0 10.328 0.672 11 1.5 11 C 2.328 11 3 10.328 3 9.5 L 3 5 L 5.25 5 L 5.25 9.5 C 5.25 10.328 5.922 11 6.75 11 C 7.578 11 8.25 10.328 8.25 9.5 L 8.25 5 L 10.5 5 L 10.5 9.5 C 10.5 10.328 11.172 11 12 11 C 12.828 11 13.5 10.328 13.5 9.5 L 13.5 5 L 15.75 5 L 15.75 9.5 C 15.75 10.328 16.422 11 17.25 11 C 18.078 11 18.75 10.328 18.75 9.5 L 18.75 5 L 21 5 L 21 9.5 C 21 10.328 21.672 11 22.5 11 C 23.328 11 24 10.328 24 9.5 C 24 9.326 22 3 22 3 L 1 3 z M 4.125 10.5 C 3.613 11.423 2.628 12.0625 1.5 12.0625 C 1.329 12.0625 1.163 12.028 1 12 L 1 24 L 14 24 L 14 14 L 20 14 L 20 24 L 23 24 L 23 12 C 22.837 12.028 22.671 12.0625 22.5 12.0625 C 21.372 12.0625 20.388 11.422 19.875 10.5 C 19.363 11.422 18.378 12.0625 17.25 12.0625 C 16.122 12.0625 15.137 11.423 14.625 10.5 C 14.113 11.423 13.128 12.0625 12 12.0625 C 10.872 12.0625 9.887 11.423 9.375 10.5 C 8.863 11.423 7.878 12.0625 6.75 12.0625 C 5.622 12.0625 4.637 11.423 4.125 10.5 z M 4 14 L 11 14 L 11 20 L 4 20 L 4 14 z"></path>
    </symbol>
    <symbol viewBox="0 0 48 48" id="color-novel">
    ...
    <symbol viewBox="0 0 48 48" id="color-donate">
        ...
        <path fill="#FFCDD2"
              d="M18.2,36c-1.3,0.6-2.8,0-3.3-1.3c-0.6-1.3,0-2.8,1.3-3.3C17.4,30.8,19.4,35.4,18.2,36z"></path>
    </symbol>
    <symbol viewBox="0 0 48 48" id="color-courses">
    ...
    <symbol viewBox="0 0 48 48" id="color-good-quality">
    ...
    <symbol viewBox="0 0 24 24" id="androidL-marker">
        <path
            d="M12,2C8.1,2,5,5.1,5,9c0,6,7,13,7,13s7-7.1,7-13C19,5.1,15.9,2,12,2z M12,11.5c-1.4,0-2.5-1.1-2.5-2.5 c0-1.4,1.1-2.5,2.5-2.5s2.5,1.1,2.5,2.5C14.5,10.4,13.4,11.5,12,11.5z"></path>
    </symbol>
    <symbol viewBox="0 0 24 24" id="androidL-user">
        <path
            d="M 12 4 C 9.790861 4 8 5.790861 8 8 C 8 10.209139 9.790861 12 12 12 C 14.209139 12 16 10.209139 16 8 C 16 5.790861 14.209139 4 12 4 z M 12 14 C 5.9 14 4 18 4 18 L 4 20 L 20 20 L 20 18 C 20 18 18.1 14 12 14 z"></path>
    </symbol>
    <symbol viewBox="0 0 32 32" id="win10-email">
        <path
            style="text-indent:0;text-align:start;line-height:normal;text-transform:none;block-progression:tb;-inkscape-font-specification:Bitstream Vera Sans"
    ...
    <symbol viewBox="0 0 24 24" id="androidL-phone">
        <path
            d="M16,15l-2.6,2.6c-1.4,0-7-5.6-7-7L9,8V4c0-0.6-0.4-1-1-1H4C3.4,3,3,3.4,3,4v2c0,7,9,15,15,15h2c0.6,0,1-0.4,1-1v-4 c0-0.6-0.4-1-1-1H16z"></path>
    </symbol>
    <symbol viewBox="0 0 24 24" id="androidL-box">
        <path
            d="M 6.09375 4 C 5.39375 4 4.80625 4.4 4.40625 5 L 2.1875 8.59375 C 2.0875 8.79375 2 9.2 2 9.5 L 2 20 C 2 21.1 2.9 22 4 22 L 20 22 C 21.1 22 22 21.1 22 20 L 22 16 L 22 9.5 C 22 9.2 21.9125 8.79375 21.8125 8.59375 L 19.59375 5 C 19.19375 4.4 18.60625 4 17.90625 4 L 6.09375 4 z M 5.90625 6 L 11 6 L 11 9 L 4.1875 9 L 5.90625 6 z M 13 6 L 18.09375 6 L 19.8125 9 L 13 9 L 13 6 z M 9 11 L 15 11 C 15.6 11 16 11.4 16 12 C 16 12.6 15.6 13 15 13 L 9 13 C 8.4 13 8 12.6 8 12 C 8 11.4 8.4 11 9 11 z"></path>
    </symbol>
    <symbol viewBox="0 0 24 24" id="androidL-calendar">
        <path
            d="M 6 2 L 6 4 L 5 4 C 3.9 4 3 4.9 3 6 L 3 20 C 3 21.1 3.9 22 5 22 L 19 22 C 20.1 22 21 21.1 21 20 L 21 6 C 21 4.9 20.1 4 19 4 L 18 4 L 18 2 L 16 2 L 16 4 L 8 4 L 8 2 L 6 2 z M 5 9 L 19 9 L 19 20 L 5 20 L 5 9 z M 12 13 L 12 18 L 17 18 L 17 13 L 12 13 z"
            fill-rule="evenodd"></path>
    </symbol>
    <symbol viewBox="0 0 24 24" id="android-clock">
        <path
    ...
    <symbol viewBox="0 0 48 48" id="color-truck">
        <path fill="#FFC107"
              d="M43,36H29V14h10.559c0.86,0,1.625,0.551,1.897,1.368L45,26v8C45,35.105,44.105,36,43,36"></path>
    ...
    <symbol viewBox="0 0 48 48" id="color-price-tag-usd">
    ...
    <symbol viewBox="-79 0 340.3 500" id="drop-box">
        <style type="text/css">
            .st0 {
                fill: #231F20;
            }
    ...
    <symbol viewBox="0 0 48 48" id="color-speech-bubble">
        <path fill="#673AB7"
              d="M39,6H9C7.343,6,6,7.343,6,9v33l8.556-8H39c1.656,0,3-1.344,3-3V9C42,7.343,40.656,6,39,6z"></path>
        <g>
    ...
    <symbol viewBox="0 0 48 48" id="color-search">
        <g>

            <rect x="34.6" y="28.1" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -15.1544 36.5859)" fill="#616161"
                  width="4" height="17"></rect>
            <circle fill="#616161" cx="20" cy="20" r="16"></circle>
        </g>
        <rect x="36.2" y="32.1" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -15.8392 38.2393)" fill="#37474F"
    ...
    <symbol viewBox="0 0 48 48" id="color-aed">
    ...
    <symbol viewBox="0 0 48 48" id="color-shopping-cart-loaded">
        <rect x="25.6" y="7.6" transform="matrix(0.7071 0.7071 -0.7071 0.7071 19.2721 -18.5269)" fill="#F57C00"
              width="12.7" height="12.7"></rect>
        <rect x="15.9" y="4.9" transform="matrix(0.7071 0.7071 -0.7071 0.7071 15.2218 -12.7487)" fill="#FF9800"
              width="14.1" height="14.1"></rect>
        <g>
    ...
    <symbol viewBox="0 0 48 48" id="color-shop">
        ...
        <path fill="#90A4AE"
              d="M36.5,33.5c-0.3,0-0.5,0.2-0.5,0.5v2c0,0.3,0.2,0.5,0.5,0.5S37,36.3,37,36v-2C37,33.7,36.8,33.5,36.5,33.5z"></path>
        <g>
  ...
  c-9.925,0-18-8.075-18-18S14.075,6.001,24,6.001z"></path>
        <g>
            <line fill="none" stroke="#2196F3" stroke-width="4" stroke-linecap="square" x1="24" y1="5" x2="24"
                  y2="11"></line>
            <line fill="none" stroke="#2196F3" stroke-width="4" stroke-linecap="square" x1="24" y1="37" x2="24"
                  y2="43"></line>
            <line fill="none" stroke="#2196F3" stroke-width="4" stroke-linecap="square" x1="11" y1="24" x2="5"
                  y2="24"></line>
        </g>
  ...
  l0.3,0.3c0.8,0.8,2,0.8,2.8,0l0,0C37.6,30.3,37.6,29,36.8,28.2z"></path>
    ...
    C8.7,28.5,8.7,29.7,9.5,30.5z"></path>
        ...
        <g>
            <path fill="#EBAE55"
                  d="M20.5,37.9L19,36.5l0.4-0.4c0.4-0.4,0.9-0.4,1.3,0l0.1,0.1c0.4,0.4,0.4,0.9,0,1.3L20.5,37.9z"></path>
            <path fill="#EBAE55"
                  d="M17.6,35.1l-1.4-1.4l0.4-0.4c0.4-0.4,0.9-0.4,1.3,0l0.1,0.1c0.4,0.4,0.4,0.9,0,1.3L17.6,35.1z"></path>
            <path fill="#EBAE55"
                  d="M14.8,32.3l-1.4-1.4l0.4-0.4c0.4-0.4,0.9-0.4,1.3,0l0.1,0.1c0.4,0.4,0.4,0.9,0,1.3L14.8,32.3z"></path>
            <path fill="#EBAE55"
                  d="M12,29.5L10.6,28l0.4-0.4c0.4-0.4,0.9-0.4,1.3,0l0.1,0.1c0.4,0.4,0.4,0.9,0,1.3L12,29.5z"></path>
        </g>
    </symbol>
    <symbol viewBox="0 0 48 48" id="color-hourglass">
        <g>
            <path fill="#BBDEFB"
                  d="M33,34.251c0-4.972-9-12.376-9-12.376s-9,7.404-9,12.376s4.029,7.874,9,7.874S33,39.223,33,34.251z"></path>
            <g>
                <path fill="#BBDEFB"
                      d="M33,13.75c0,4.973-9,12.376-9,12.376s-9-7.403-9-12.376c0-4.972,4.028-7.875,9-7.875S33,8.778,33,13.75z"></path>
            </g>
        </g>
        <g>
            <path fill="#FF9800"
                  d="M17.699,16c1.235,2.373,3.906,5.313,6.301,7.481c2.395-2.169,5.065-5.108,6.301-7.481H17.699z"></path>
      ...
      C19.115,39.332,21.692,40.125,24,40.125z"></path>
        ...
        <g>
            <path fill="#6D4C41"
                  d="M33,39c0-0.553-0.447-1-1-1H16c-0.552,0-1,0.447-1,1v4c0,0.553,0.448,1,1,1h16c0.553,0,1-0.447,1-1V39z"></path>
            <path fill="#6D4C41"
                  d="M33,9c0,0.553-0.447,1-1,1H16c-0.552,0-1-0.447-1-1V5c0-0.553,0.448-1,1-1h16c0.553,0,1,0.447,1,1V9z"></path>
        </g>
        <g>
            <path fill="#8D6E63"
                  d="M36,42c0-0.553-0.447-1-1-1H13c-0.552,0-1,0.447-1,1v1c0,0.553,0.448,1,1,1h22c0.553,0,1-0.447,1-1V42z"></path>
            <path fill="#8D6E63"
                  d="M36,6c0,0.553-0.447,1-1,1H13c-0.552,0-1-0.447-1-1V5c0-0.553,0.448-1,1-1h22c0.553,0,1,0.447,1,1V6z"></path>
        </g>
    </symbol>
    <symbol viewBox="0 0 48 48" id="color-clinic">
    ...
    <symbol viewBox="0 0 48 48" id="color-globe-earth">
        ...
        <line fill="none" stroke="#8D6E63" stroke-width="2" stroke-miterlimit="10" x1="11.572" y1="5" x2="39.316"
              y2="32.745"></line>
        <g>
            <circle fill="none" stroke="#1E88E5" stroke-width="2" cx="24.535" cy="17.963" r="11"></circle>

            <ellipse transform="matrix(-0.7071 -0.7071 0.7071 -0.7071 29.1811 48.0148)" fill="none" stroke="#1E88E5"
                     stroke-width="2" stroke-miterlimit="10" cx="24.535" cy="17.963" rx="11" ry="5.499"></ellipse>

            <line fill="none" stroke="#1E88E5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                  stroke-miterlimit="10" x1="27.129" y1="7.594" x2="14.165" y2="20.557"></line>

            <line fill="none" stroke="#1E88E5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                  stroke-miterlimit="10" x1="34.906" y1="15.371" x2="21.943" y2="28.336"></line>
            <line fill="none" stroke="#1E88E5" stroke-width="2" stroke-miterlimit="10" x1="16.757" y1="25.742"
                  x2="32.313" y2="10.185"></line>
            <line fill="none" stroke="#1E88E5" stroke-width="2" stroke-miterlimit="10" x1="16.757" y1="10.185"
                  x2="32.313" y2="25.742"></line>
        </g>
        <g>
    ...
    <symbol viewBox="0 0 48 48" id="color-ask-question">
        <path fill="#2196F3"
              d="M39,6H9C7.343,6,6,7.343,6,9v33l8.556-8H39c1.656,0,3-1.344,3-3V9C42,7.343,40.656,6,39,6z"></path>
  ...
  z"></path>
    ...
    <symbol viewBox="0 0 48 48" id="color-survival-bag">
        <g>
            <path fill="#827717" d="M42,39c0,1.656-1.344,3-3,3H9c-1.657,0-3-1.344-3-3V14h36V39z"></path>
            <path fill="none" stroke="#827717" stroke-width="2" d="M7,14c0,0,0-7,17-7s17,7,17,7"></path>
        </g>
        <g>
            <rect x="22" y="19" fill="#F9FBE7" width="4" height="12"></rect>
            <rect x="18" y="23" fill="#F9FBE7" width="12" height="4"></rect>
        </g>
        <path fill="#60560B" d="M40,14v18c0,1.656-1.344,3-3,3H11c-1.657,0-3-1.344-3-3V14H6v19c0,2.757,2.243,5,5,5h26c2.757,0,5-2.243,5-5
	V14H40z"></path>
    </symbol>
</svg>
